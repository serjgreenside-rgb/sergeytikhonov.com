...
$base64 = [FrameExtractor]::GetFrameBase64($videoPath, 0.0)

Set-Content -Path "C:\Users\User\.gemini\antigravity\scratch\sergey-portfolio\frame_00.txt" -Value $base64
Write-Host "Wrote frame_00.txt. Length: $($base64.Length)"
